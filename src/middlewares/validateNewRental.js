...
export async function validateNewRental(req, res, next) {
    ...
    try {
        ...
        const checkCostumer = await connection.query("SELECT * FROM customers WHERE id = $1;", [customerId]);
        ...
        const checkRentals = await connection.query(`SELECT * FROM rentals WHERE "gameId" = $1;`, [gameId]);
